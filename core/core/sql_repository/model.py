from abc import ABC
from typing import Type, AsyncGenerator, Tuple, List, Callable, Any
...
from .exeptions import SessionNotFound, GetMultiple, SQLInjection
...
class Repository(ABC):
    ...
    def __init__(self, model: Type[T], session: AsyncSession, relationships: tuple[str, ...] | None = None):
        self.model = model
